...
export const servicesData = {
  'desarrollo-web': {
    ...
    process: [
      {
        ...
        description: 'Definimos arquitectura, tecnologías y roadmap del proyecto',
    ...
    technologies: ['React', 'Next.js', 'Node.js', 'Python', 'TypeScript', 'Tailwind CSS'],
    features: [
  ...
  'apps-moviles': {
    ...
    process: [
      ...
      },
      {
        ...
        description: 'Prototipos interactivos siguiendo guidelines de iOS/Android',
  ...
  'marketing-digital': {
    ...
    technologies: ['Google Ads', 'Facebook Ads', 'Instagram', 'LinkedIn', 'Email Marketing', 'SEO'],
    features: [
  ...
  'apis-integracion': {
    ...
    description: 'Desarrollamos APIs robustas e integramos sistemas empresariales complejos.',
    process: [
      {
    ...
    technologies: ['REST', 'GraphQL', 'Node.js', 'Python', 'API Gateway', 'OAuth'],
    features: [
  ...
  'soporte-hardware-software': {
    ...
    technologies: ['Windows', 'macOS', 'Linux', 'Office 365', 'Google Workspace', 'Antivirus'],
    features: [
  ...
  'ui-ux-design': {
    ...
    technologies: ['Figma', 'Sketch', 'Adobe XD', 'Principle', 'InVision', 'Hotjar'],
    features: [
  ...
  'estrategia-digital': {
    ...
    technologies: ['Business Intelligence', 'Analytics', 'CRM', 'ERP', 'Cloud Platforms', 'AI/ML'],
    features: [
  ...
  'devops-automatizacion': {
    ...
    process: [
      {
        ...
        description: 'Evaluación de procesos actuales y identificación de mejoras',
    ...
    technologies: ['Docker', 'Kubernetes', 'Jenkins', 'Terraform', 'Ansible', 'Prometheus'],
    features: [
      'CI/CD automatizado',
