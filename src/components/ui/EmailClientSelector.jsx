 ...
 * @property {string} to - Destinatario del email
 * @property {string} subject - Asunto del email
 * @property {string} body - Cuerpo del email
 */
...
export const EmailClientSelector = React.memo(
  (
    /** @type {{emailData: EmailData, onClose: () => void, isOpen: boolean}} */ {
      emailData,
      onClose,
      isOpen,
    }
    ...
    const handleClientSelection = (/** @type {string} */ url, isExternal = false) => {
      if (isExternal) {
        ...
        >
          ...
          <div className="p-6 border-b border-gray-700">
            <div className="flex items-center gap-3 mb-3">
              <img src="/axon-logo-principal.png" alt="Axon.App" className="w-10 h-10 rounded-lg" />
              <h3 id="email-selector-title" className="text-xl font-bold text-white">
                Elige tu cliente de correo
              </h3>
            </div>
            <p className="text-gray-400 text-sm">Selecciona dónde quieres redactar tu mensaje</p>
          </div>
          ...
          <div className="p-6 space-y-3">
            ...
            >
              ...
              <div className="text-left">
                ...
                <div className="text-xs text-red-200">Recomendado para cuentas @gmail.com</div>
              </div>
            </button>
            {/* Outlook */}
            <button
            ...
            >
              ...
              <div className="text-left">
                <div className="font-semibold text-white">Outlook / Hotmail</div>
            ...
            >
              ...
              <div className="text-left">
                <div className="font-semibold text-white">Cliente predeterminado</div>
                <div className="text-xs text-gray-300">Aplicación de correo del sistema</div>
              </div>
            </button>
          </div>
