...
export const ClientCard = ({ client, index }) => {
  ...
  return (
    <>
      ...
      >
        ...
        <div className="flex items-center justify-between mb-4">
          <div className="flex items-center space-x-4">
            <div
              className={`w-12 h-12 bg-gradient-to-br ${client.logoColor} \
            ...
            <div>
              <h3
                className="text-lg font-bold text-white group-hover:text-blue-300 \
        ...
        <div className="mb-4">
          <h4
            className="text-white font-semibold mb-2 group-hover:text-blue-300 \
            transition-colors duration-300"
          >
        ...
        <div className="mb-4">
          <div className="bg-green-500/10 border border-green-500/30 rounded-lg p-3">
            ...
            <p className="text-green-100 text-sm">{client.results[0]}</p>
          </div>
        </div>
        ...
        <div className="flex items-center justify-between text-sm">
          ...
          <div className="text-blue-300 font-medium">{client.project.type}</div>
        </div>
      ...
      {showDetails && <ClientDetailModal client={client} onClose={() => setShowDetails(false)} />}
    </>
  );
};
      ...
      <div className="bg-gradient-to-br from-gray-800 to-gray-900 rounded-3xl max-w-4xl w-full max-h-[90vh] overflow-y-auto">
        ...
        <div className="sticky top-0 bg-gradient-to-br from-gray-800 to-gray-900 p-6 border-b border-gray-700/50">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-4">
              <div
                className={`w-16 h-16 bg-gradient-to-br ${client.logoColor} \
