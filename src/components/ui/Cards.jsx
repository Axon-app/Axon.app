...
const IconsLibrary = {
  ...
  mobile: (
    ...
    >
      <path
        d="M16 1H8C6.34 1 5 2.34 5 4v16c0 1.66 1.34 3 3 3h8c1.66 0 3-1.34 3-3V4c0-1.66-1.34-3-3-3zm1 17H7V4h10v14zm-3-2H10v-1h4v1z"
        fill="currentColor"
      />
    </svg>
  ),
  ...
  analytics: (
    ...
    >
      <path
        d="M19 3H5c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2zM9 17H7v-7h2v7zm4 0h-2v-10h2v10zm4 0h-2V8h2v9z"
        fill="currentColor"
      />
    </svg>
  ),
  devops: (
    ...
    >
      <path
        d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm0 18l-4-4h3V8h2v8h3l-4 4z"
        fill="currentColor"
      />
    </svg>
  ),
...
export const ServiceCard = React.memo(({ title, description, onOpenModal, id }) => {
  ...
  return (
    <div className="bg-slate-800/60 backdrop-blur-md rounded-xl p-6 sm:p-8 transform transition-all duration-300 hover:shadow-cyan-500/30 hover:-translate-y-2 shadow-xl border border-cyan-500/30">
      <div className="flex items-center mb-4 sm:mb-6">
        ...
        />
        <div>
          <h4 className="text-lg sm:text-xl font-semibold text-cyan-400">{testimonial.name}</h4>
