    ...
    <>
      ...
      >
        ...
        <div className="mt-4 text-center text-xs sm:text-sm text-gray-400">
          ...
          <EmailLink
            mailtoUrl="mailto:axonapp.info@gmail.com?subject=Consulta%20desde%20formulario%20de%20contacto%20-%20Axon.App&body=Hola%20equipo%20de%20Axon.App,%0A%0AMe%20gustaría%20ponerme%20en%20contacto%20con%20ustedes%20para:%0A%0A%0A%0AMis%20datos%20de%20contacto:%0ANombre:%20%0AEmpresa:%20%0ATeléfono:%20%0AEmail:%20%0A%0AEspero%20su%20respuesta.%0A%0AGracias,"
      ...
      {showErrorModal && (
        ...
        >
          <div
            className="bg-gradient-to-br from-red-900 to-rose-900 rounded-2xl p-6 sm:p-8 max-w-md w-full border border-red-500/30 shadow-2xl"
          ...
          >
            <div className="text-center">
              ...
              <p className="text-red-200 mb-4 text-sm sm:text-base">
                Hubo un problema al enviar tu mensaje. Por favor, inténtalo
                nuevamente o contáctanos directamente.
              </p>
              <div className="text-red-300 text-xs sm:text-sm mb-6">
                📧 Email directo:{" "}
                <EmailLink
                  mailtoUrl="mailto:axonapp.info@gmail.com?subject=Contacto%20directo%20-%20Axon.App&body=Hola%20equipo%20de%20Axon.App,%0A%0ANo%20pude%20enviar%20el%20formulario%20de%20contacto,%20por%20lo%20que%20me%20comunico%20directamente:%0A%0ANombre:%20%0AEmpresa:%20%0ATeléfono:%20%0AEmail:%20%0A%0AMensaje:%0A%0A%0A%0AGracias,"
                  className="underline hover:text-red-200 text-red-300 cursor-pointer"
                >
                  axonapp.info@gmail.com
                </EmailLink>
              </div>
              <button
                onClick={() => setShowErrorModal(false)}
                className="bg-red-600 hover:bg-red-700 text-white font-bold py-2 sm:py-3 px-6 sm:px-8 rounded-full transition-all duration-300 transform hover:scale-105 text-sm sm:text-base focus:outline-none focus:ring-2 focus:ring-red-400"
