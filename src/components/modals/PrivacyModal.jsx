 ...
 */
export const EnhancedPrivacyModal = React.memo(
            ...
            <div className="prose prose-invert prose-blue max-w-none">
              ...
              <section>
                ...
                <p className="leading-relaxed mb-4">
                  ...
                  excepto cuando sea necesario para proporcionar nuestros servicios o cuando la ley
                  lo requiera.
                </p>
              ...
              <section>
                ...
                <p className="leading-relaxed mt-3 text-sm text-gray-400">
                  <strong>Tiempo de respuesta:</strong> Responderemos a su solicitud dentro de 30
                  días hábiles.
                </p>
              </section>
            </div>
