          ...
          <div className="prose prose-invert prose-blue max-w-none">
            <section>
              ...
              <p className="leading-relaxed mb-4">
                En Axon.app, recopilamos únicamente la información necesaria para proporcionar
                nuestros servicios de desarrollo web y consultoría tecnológica:
              </p>
            ...
            <section>
              <h3 className="text-xl font-semibold text-blue-300 mb-3">2. Uso de la Información</h3>
              <p className="leading-relaxed mb-4">Utilizamos su información exclusivamente para:</p>
              <ul className="list-disc pl-6 space-y-2">
            ...
            <section>
              <h3 className="text-xl font-semibold text-blue-300 mb-3">3. Protección de Datos</h3>
              <p className="leading-relaxed mb-4">
            ...
            <section>
              <h3 className="text-xl font-semibold text-blue-300 mb-3">4. Compartir Información</h3>
              <p className="leading-relaxed mb-4">
                No vendemos, alquilamos ni compartimos su información personal con terceros, excepto
                cuando sea necesario para proporcionar nuestros servicios o cuando la ley lo
                requiera.
              </p>
              <p className="leading-relaxed text-sm text-gray-400">
                <strong>Excepciones:</strong> Podemos compartir información con proveedores de
                servicios de confianza que nos ayudan a operar nuestro sitio web y brindar
                servicios, siempre bajo estrictos acuerdos de confidencialidad.
              </p>
            </section>

            <section>
              <h3 className="text-xl font-semibold text-blue-300 mb-3">5. Sus Derechos</h3>
              <p className="leading-relaxed mb-4">
                De acuerdo con las regulaciones de protección de datos (GDPR, CCPA), usted tiene
                derecho a:
              </p>
              <ul className="list-disc pl-6 space-y-2">
                <li>
            ...
            <section>
              <h3 className="text-xl font-semibold text-blue-300 mb-3">6. Retención de Datos</h3>
              <p className="leading-relaxed mb-4">
            ...
            <section>
              <h3 className="text-xl font-semibold text-blue-300 mb-3">7. Contacto</h3>{' '}
              ...
              <p className="leading-relaxed mt-3 text-sm text-gray-400">
                <strong>Tiempo de respuesta:</strong> Responderemos a su solicitud dentro de 30 días
                hábiles.
              </p>
            </section>
          </div>
