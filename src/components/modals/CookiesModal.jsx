 ...
 * @property {boolean} necessary - Cookies necesarias
 * @property {boolean} analytics - Cookies de análisis
 * @property {boolean} marketing - Cookies de marketing
 * @property {boolean} preferences - Cookies de preferencias
 */

/**
 * @typedef {'necessary'|'analytics'|'marketing'|'preferences'} CookieType
 */
 ...
 */
export const EnhancedCookiesModal = React.memo(
  (/** @type {{isOpen: boolean, onClose: () => void}} */ { isOpen, onClose }) => {
    // Estado de preferencias de cookies
    /** @type {[CookiePreferences, React.Dispatch<React.SetStateAction<CookiePreferences>>]} */
    ...
    const togglePreference = (/** @type {CookieType} */ type) => {
    ...
    return (
      ...
      >
        <div className="bg-gradient-to-br from-gray-900 via-black to-gray-900 rounded-xl max-w-4xl w-full max-h-[85vh] overflow-y-auto shadow-2xl border border-gray-700/50">
                  ...
                  <div className="flex items-start justify-between mb-3">
                    ...
                    <div className="ml-4">
                      <label className="relative inline-flex items-center cursor-pointer">
                        <input
                          type="checkbox"
                          checked={cookiePreferences[/** @type {CookieType} */ (type.key)]}
                          onChange={() => togglePreference(/** @type {CookieType} */ (type.key))}
                        ...
                        <div
                          className={`relative w-11 h-6 bg-gray-600 peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-blue-800 rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all ${
                            cookiePreferences[/** @type {CookieType} */ (type.key)]
          ...
          {/* Footer Actions */}
          <div className="sticky bottom-0 bg-gray-900/95 backdrop-blur-md border-t border-gray-700 p-4 sm:p-6">
