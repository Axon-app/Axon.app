...
export const EnhancedTermsModal = React.memo(
          ...
          <div className="p-4 sm:p-6 space-y-6 text-gray-300">
            <div className="prose prose-invert prose-blue max-w-none">
              ...
              <section>
                ...
                <ul className="list-disc pl-6 space-y-2">
                  <li>
                    <strong>Cancelación:</strong> Los proyectos pueden cancelarse con 7 días de
                    aviso por escrito
                  </li>
                  <li>
                    <strong>Reembolsos:</strong> Se calculan basándose en el trabajo completado
                    hasta la fecha
                  </li>
                  <li>
                    <strong>Entregables:</strong> El cliente recibe todos los entregables
                    completados
                  </li>
                  <li>
              ...
              <section>
                ...
                <p className="leading-relaxed">
                  ...
                  cambios serán comunicados con al menos 30 días de anticipación a través de
              ...
              <section>
                ...
                <p className="leading-relaxed mt-3 text-sm text-gray-400">
                  <strong>Tiempo de respuesta:</strong> Responderemos a consultas legales dentro de
                  5 días hábiles.
                </p>
              </section>
            </div>
