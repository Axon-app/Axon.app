          ...
          <div className="prose prose-invert prose-blue max-w-none">
            ...
            <section>
              ...
              <p className="leading-relaxed">
                Al acceder y utilizar los servicios de Axon.app, usted acepta cumplir con estos
              ...
              <p className="leading-relaxed text-sm text-gray-400 mt-3">
                <strong>Nota importante:</strong> Estos términos constituyen un acuerdo legal
                vinculante entre usted y Axon.app.
              </p>
            </section>

            <section>
              <h3 className="text-xl font-semibold text-blue-300 mb-3">2. Servicios Ofrecidos</h3>
              <p className="leading-relaxed mb-4">
                Axon.app proporciona servicios profesionales de desarrollo web, incluyendo pero no
                limitado a:
              </p>
              <ul className="list-disc pl-6 space-y-2">
                <li>Desarrollo de sitios web personalizados y aplicaciones web</li>
                <li>Aplicaciones web progresivas (PWA) y soluciones móviles</li>
                <li>Consultoría en tecnologías web modernas y arquitectura</li>
                <li>Optimización de rendimiento, SEO y experiencia de usuario</li>
            ...
            <section>
              ...
              <ul className="list-disc pl-6 space-y-2">
                <li>
                  <strong>Información:</strong> Proporcionar información precisa, completa y
                  actualizada
                </li>
                <li>
                  <strong>Comunicación:</strong> Brindar feedback oportuno durante el proceso de
                  desarrollo
                </li>
                <li>
                  <strong>Pagos:</strong> Cumplir con los plazos de pago acordados según el
                  cronograma
                </li>
                <li>
                  <strong>Propiedad:</strong> Respetar los derechos de propiedad intelectual de
                  terceros
                </li>
                <li>
            ...
            <section>
              <h3 className="text-xl font-semibold text-blue-300 mb-3">4. Propiedad Intelectual</h3>
              <p className="leading-relaxed mb-4">
                Los derechos de propiedad intelectual se distribuyen de la siguiente manera:
              </p>
              <ul className="list-disc pl-6 space-y-2">
                <li>
                  <strong>Contenido del cliente:</strong> El cliente posee los derechos sobre el
                  contenido proporcionado
                </li>
                <li>
                  <strong>Metodologías propias:</strong> Axon.app retiene los derechos sobre
                  metodologías y frameworks propios
                </li>
                <li>
                  <strong>Código desarrollado:</strong> El código desarrollado es propiedad del
                  cliente una vez completado el pago
                </li>
                <li>
                  <strong>Licencias de terceros:</strong> Las licencias de software de terceros se
                  rigen por sus términos específicos
                </li>
              </ul>
            </section>
            ...
            <section>
              ...
              <p className="leading-relaxed mb-4">
                Axon.app no será responsable por daños indirectos, incidentales o consecuenciales
                que puedan surgir del uso de nuestros servicios. Nuestra responsabilidad se limita
                al valor del contrato específico.
              </p>
              <p className="leading-relaxed text-sm text-gray-400">
                <strong>Excepciones:</strong> Esta limitación no aplica en casos de negligencia
                grave, dolo o violaciones a la seguridad por nuestra parte.
              </p>
            </section>

            <section>
              <h3 className="text-xl font-semibold text-blue-300 mb-3">6. Garantías y Soporte</h3>
              <p className="leading-relaxed mb-4">Ofrecemos las siguientes garantías y soporte:</p>
              <ul className="list-disc pl-6 space-y-2">
                <li>
                  <strong>Garantía de errores:</strong> 30 días de corrección de errores sin costo
                  adicional
                </li>
                <li>
                  <strong>Soporte técnico:</strong> Soporte durante el período de garantía
                  especificado
                </li>
                <li>
                  <strong>Actualizaciones críticas:</strong> Actualizaciones de seguridad críticas
                  incluidas
                </li>
                <li>
                  <strong>Documentación:</strong> Entrega de documentación técnica completa
                </li>
              </ul>
            </section>
            ...
            <section>
              ...
              <p className="leading-relaxed mb-4">Política de cancelación y reembolsos:</p>
              <ul className="list-disc pl-6 space-y-2">
                <li>
                  <strong>Cancelación:</strong> Los proyectos pueden cancelarse con 7 días de aviso
                  por escrito
                </li>
                <li>
                  <strong>Reembolsos:</strong> Se calculan basándose en el trabajo completado hasta
                  la fecha
                </li>
                <li>
                  <strong>Entregables:</strong> El cliente recibe todos los entregables completados
                </li>
                <li>
                  <strong>Gastos:</strong> Los gastos incurridos no son reembolsables
                </li>
              </ul>
            </section>

            <section>
              <h3 className="text-xl font-semibold text-blue-300 mb-3">8. Confidencialidad</h3>
              <p className="leading-relaxed mb-4">
            ...
            <section>
              <h3 className="text-xl font-semibold text-blue-300 mb-3">9. Modificaciones</h3>
              <p className="leading-relaxed">
                Nos reservamos el derecho de modificar estos términos en cualquier momento. Los
                cambios serán comunicados con al menos 30 días de anticipación a través de nuestros
                canales oficiales.
              </p>
              <p className="leading-relaxed text-sm text-gray-400 mt-3">
                <strong>Aplicabilidad:</strong> Las modificaciones no afectarán proyectos en curso
                bajo términos previamente acordados.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="leading-relaxed">
                Estos términos se rigen por las leyes aplicables en la jurisdicción donde opera
                Axon.app. Cualquier disputa será resuelta mediante arbitraje o en los tribunales
                competentes de dicha jurisdicción.
              </p>
            </section>

            <section>
              <h3 className="text-xl font-semibold text-blue-300 mb-3">11. Contacto</h3>{' '}
              <p className="leading-relaxed">
              ...
              <p className="leading-relaxed mt-3 text-sm text-gray-400">
                <strong>Tiempo de respuesta:</strong> Responderemos a consultas legales dentro de 5
                días hábiles.
              </p>
            </section>
          </div>
